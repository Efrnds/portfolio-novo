    ...
    <div className="flex flex-col flex-1 w-2/3 h-full py-10 mx-auto pt-20 sm:pt-24">
      <div className="m-auto">
        ...
        <div className="flex flex-col gap-4">
          <p className="text-lg">
            Portfolio developed for a client of my agency,{" "}
            <a
              href="https://www.align-websites.tech/"
          ...
          <p>
            As one of the first client&rsquo;s of my agency, they approached us
            seeking a unique and sophisticated portfolio that would stand out in
            their industry.
          </p>
          <p>
            We chose Next.js as our framework, leveraging its powerful image
            optimization capabilities to deliver a highly performant website
            that handles the client&rsquo;s extensive image gallery efficiently.
          </p>
          <p>
